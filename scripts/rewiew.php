...
"From: goldirev12@yandex.ru \r\n"))
 {     	echo "<center><b>Ваш отзыв успешно размещен на сайте!</b><br><br><center>Через 3 секунды Вы будете перенаправлены на предыдущую страницу<br><br>Если этого не произошло, то нажмите на ссылку:<br><a href='/guestbook.php'>Вернуться назад</a>"; 
header('Refresh: 3; URL=/guestbook.php');
} 
else { 
    echo "<center>При отправке отзыва возникли проблемы :(<br><a href='/guestbook.php'>Вернуться назад</a>";
}}
else {
	echo "<center>Вы не заполнили одно из обязательных полей формы, вернитесь, пожалуйста, и заполните его<br><a href='/guestbook.php'>Вернуться назад</a>";
}
}
else{
