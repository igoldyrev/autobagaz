<div class="form__container">
  <form action="/rewiew" method="post" class="form" onsubmit="yaCounter40650914.reachGoal('post_rewiew'); return true">
    ...
    <div class="form__input-wrap">
      <input type="text" name="phone" class="form__input"
             placeholder="Введите номер телефона. Номер телефона НЕ публикуется">
    ...
    <button class="button button__zakaz">Оставить отзыв</button>
    <p class="text auth__license">Нажимая кнопку «Оставить отзыв» вы соглашаетесь с <a
