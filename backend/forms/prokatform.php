<div class="form__container">
  <form action="/vprokat" method="post" class="form" onsubmit="yaCounter40650914.reachGoal('post_prokat'); return true">
    ...
    <div class="form__input-wrap clearfix">
      ...
      <input type="checkbox" name="velokreplenie_krysha" class="form__checkbox"
             id="velokreplenie_krysha" <?php echo $checkedvelokrysha ?>>
      <label for="velokreplenie_krysha" class="form__label--checkbox">Велокрепление на крышу</label>
      <input type="checkbox" name="velokreplenie_farkop" class="form__checkbox"
             id="velokreplenie_farkop" <?php echo $checkedvelofarkop ?>>
      <label for="velokreplenie_farkop" class="form__label--checkbox">Велокрепление на фаркоп</label>
      <input type="checkbox" name="lyzhnoe_kreplenie" class="form__checkbox"
             id="lyzhnoe_kreplenie" <?php echo $checkedlyzhi ?>>
    ...
    <p class="text auth__license">Нажимая кнопку «Взять в прокат» вы соглашаетесь с <a
