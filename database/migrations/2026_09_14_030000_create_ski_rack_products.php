...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('ski_rack_manufacturers', function (Blueprint $table): void { $table->id(); $table->string('name')->unique(); $table->boolean('is_active')->default(true); $table->timestamps(); });
    ...
    public function down(): void { Schema::dropIfExists('ski_rack_products'); Schema::dropIfExists('ski_rack_manufacturers'); DB::table('catalog_categories')->whereNull('parent_id')->where('slug', 'krepleniya-dlya-lyzh-i-snoubordov')->delete(); DB::table('product_types')->where('code', 'ski_rack')->delete(); }
};
