...
<div class="wrapper">
  ...
  <div class="wrapper__content">
    ...
    if (!isset($page)) {
      ...
      <?php include($_SERVER["DOCUMENT_ROOT"] . "/src/common.blocks/stock/stock.php");
      ...
      <div class="catalog">
        ...
        <div class="catalog__item">
          <a href="/expidition" class="catalog__item-link"></a>
          <div class="catalog__image-wrap">
            <img class="catalog__image" src="/content/index/img/catalog/11_expidition.JPG"
                 alt="экспедиционные багажники">
          </div>
          <div class="catalog__text">
            <p class="text">Экспедиционные багажники</p>
          </div>
        </div>
        <div class="catalog__item">
          <a href="/covers" class="catalog__item-link"></a>
          <div class="catalog__image-wrap">
            <img class="catalog__image" src="/content/covers/img/Cayman_Black_Red_Face.jpg" alt="авточехлы">
          </div>
          <div class="catalog__text">
      ...
      <p class="text">Для многих современных людей автомобиль является не только свидетельством жизненного успеха, но и
        ...
        на легковом автомобиле существует багажник, устанавливаемый на крышу авто. Это может быт как простая и
      ...
      <p class="text">К ним относится велокрепление, багажник для лодки и прочие всевозможные приспособления,
        ...
        ним, обеспечивающих комфортную и безопасную перевозку конкретного вида снаряжения. Все большее количество людей
        ...
        возможности. К тому же у нас существует такая услуга, как прокат багажников и автобовков, что будет отличным
      ...
      <div class="contacts__shop" id="dzerzhinskogo">
        ...
        <div class="img__wrap">
          <img class="img good__img" src="/content/index/img/contacts/shop_autobagaz_dzerzhinskogo-5.jpg"
               alt="autobagaz">
          <img class="img good__img" src="/content/index/img/contacts/shop_autobagaz_dzerzhinskogo-4.jpg"
               alt="autobagaz">
        </div>
        <div class="contacts__map">
      ...
      <div class="contacts__shop" id="lebedeva">
        ...
        <div class="img__wrap">
          <img class="img good__img" src="/content/index/img/contacts/shop_autobagaz_lebedeva.JPG" alt="autobagaz">
        </div>
        <div class="contacts__map">
      ...
      <div class="contacts__inn">
        ...
        <p class="text">р/с 40802810149770015620 в Волго-Вятском банке ПАО Сбербанк г. Нижний Новгород</p>
        <p class="text">БИК 042202603 к/с № 30101810900000000603</p>
      ...
      <p class="text">Подобрать багажный автомобильный бокс не трудно! Главное это определить для себя приоритетные
        задачи, которые он будет выполнять. Ну, и конечно же, чтобы бокс, который вы выбрали, вам нравился!</p>
      <p class="text">Итак, первое - определитесь, что вы хотите перевозить - кучу вещей, сноуборд или лыжи, палатку или
        надувную лодку. При подборе бокса на крышу автомобиля необходимо помнить, что внутренние размеры у него меньше
        на 5-7см, чем указанные наружные. Это необходимо учитывать, например, при перевозке лыж или сноубордов – бокс
        должен как минимум на 6см быть длиннее.</p>   <p class="speech speech__left">Какие должны быть размеры
        бокса?</p>
      <p class="speech speech__right">Далее определяемся с размерами бокса. Можно отталкиваться от габаритов вашего
        автомобиля. Хотя, честно скажу, во многих случаях это не имеет никакого значения, на крышу большого автомобиля
        можно установить маленький бокс , а на маленький автомобиль можно установить большой бокс. Все дело только в
        эстетическом виде - кому-то нравится, а кому-то нет. Определяющим здесь может стать угол открытия вверх пятой
        двери у автомобилей с кузовами типа универсал или хетчбек. Нависание автобокса над лобовым стеклом на 20-30см с
        водительского места никак не ощущается. Из этого всего можно вывести основные рекомендации по установке бокса:
        для автомобилей с пятой дверью (если она открывается наверх) крайними точками будут: 1) открытая вверх до конца
        дверь; 2) кромка лобового стекла + 30см; для всех прочих авто определяющими критериями будут габариты багажа и
        эстетика внешнего вида.</p>
      <p class="speech speech__left">Как определиться с цветом бокса?</p>
      <p class="speech speech__right">Багажные боксы производятся в универсальной цветовой гамме: чёрные, серые или
        белые. Они могут быть матовые, либо глянцевые. Эти цвета настолько универсальны, что подойдут автомобилю любой
        расцветки. В крайнем случае, если вы хотите чего-то более экстравагантного, то всегда можно его перекрасить или
        приукрасить аэрографией.</p>
      <p class="speech speech__left">Как автобокс влияет на расход топлива?</p>
      <p class="speech speech__right">Чем больше габаритные размеры бокса, тем выше сопротивление воздуха при движении.
        Существуют автобоксы с улучшенной аэродинамикой, такие как Thule Dynamic, Thule Excellence, Hapro Zenith, Menabo
        Mania. Но в любом случае порядка 1 литра топлива на сотню к расходу надо будет добавить.<br><br>Удобство
        установки зависит от того, как бокс крепится к поперечинам базового багажника. Возможны разные варианты
        крепления: простейший - четырьмя скобами с 8-ю «барашками», на установку уйдет минут 15 и необходим помощник,
        который будет держать скобу, пока вы её прикручиваете; скобы с системой зажима Easy-Fit фирмы Hapro, на
        установку уйдет минут 5-7 и нужен помощник, удерживающий скобу, пока вы её затягиваете; «клешни» c системой
        затяжки Dual Force фирмы Thule, позволяющей зафиксировать бокс за 2-3 минуты, сделать это можно одному, без
        посторонней помощи.</p>
      <p class="speech speech__left">Какие бывают системы открывания крышек автобоксов?</p>
      <p class="speech speech__right">Таковых бывает три типа: открывание бокса сзади, сбоку и с обеих сторон. Сразу
        скажу, что двухстороннее открытие даёт преимущество при установке автобокса – не надо тянуться к дальним точкам
        фиксации обтирая пыльный автомобиль (в случае, если крыша высокая, бывает, что без стремянки не обойтись) и при
        распределении багажа внутри бокса + возможность достать его с любой стороны.</p>
      <p class="speech speech__left">Как выбрать бокс из наиболее качественного пластика?</p>
      <p class="speech speech__right">Качество пластика определяется устойчивостью к ультрафиолетовым лучам,
        ударопрочностью, отсутствием запаха. Имейте ввиду, что толстый пластик – это не всегда хорошо. Новейшие
        технологии производства позволяют использовать тонкий , эластичный и прочный пластик ABS , который даёт все выше
        перечисленные преимущества и в добавок он меньше весит. Из такого пластика делают свои багажные боксы все
        серьёзные производители.</p>
      <p class="speech speech__left">А как мне выбрать наиболее лучшего производителя?</p>
      <p class="speech speech__right">Чем известней бренд, тем выше качество и комфорт в эксплуатации. Такими брендами
        являются известные всем фирмы, такие как: Thule - Швеция (флагман в мире багажников для автомобилей), Mont Blanc
        – Швеция, Hapro – Голландия. И менее известные: Menabo – Италия, Farad – Италия. <br><br>Так же существуют
        китайские производители боксов, которые внешне копируют знаменитые бренды, но не всегда их качество
        соответствует необходимым параметрам. Замечу, что и у китайских производителей, есть достойные представители
        жанра, такие как, например, Nord.</p>
      <p class="speech speech__left">И все-таки, как мне выбрать такой бокс, чтобы он был совместим с моим багажником
        (поперечинами)?</p>
      <p class="speech speech__right">При выборе бокса на крышу уточняйте, насколько он будет совместим с перекладинами
        базового багажника. Перекладины бывают трёх видов:<br><br>Прямоугольные – на них устанавливаются все виды
        автобоксов с различными типами креплений.<br><br>Овальные аэродинамические – на них устанавливается 85% багажных
        боксов со своими креплениями. Для оставшихся 15% необходимо будет приобрести дополнительные переходники в
        Т-образный профиль.<br><br>Крыло (Thule WingBar и Yakima Whispbar) - на них устанавливается 65% боксов на крышу,
        для остальных приобретаются переходники. Смею заметить, что такой профиль является третьим поколением багажников
        на крышу и представляет собой полностью бесшумный профиль, он наиболее комфортен, его преимущество в том, что
        вам нет необходимости снимать его с автомобиля. И ко всему он придает вашему средству передвижения эстетический
        вид.</p>
      <?php
    } ?>
  </div>
