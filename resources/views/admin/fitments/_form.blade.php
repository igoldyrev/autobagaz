...
@include('admin.partials.help', ['id' => 'fitment-form-help-title', 'title' => 'Как заполнить группу', 'text' => 'Объединяйте только багажники, которые устанавливаются на один и тот же набор автомобилей. Сначала сохраните название, код и товары, затем нажмите «Настроить автомобили». После добавления автомобилей используйте предпросмотр, чтобы проверить все получившиеся связи.', 'items' => []])
<div class="form-grid">
...
<p class="field__hint field--wide">Отключённая группа сохраняет товары и автомобили, но не участвует в автоматической проверке совместимости.</p>
</div>
