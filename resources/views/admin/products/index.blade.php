...
@section('body')
    <div class="admin-shell">
        ...
        <main class="admin-content admin-content--wide">
            ...
            @include('admin.partials.help', ['title' => 'Работа со списком', 'text' => 'Поиск проверяет название автобагажника, а фильтр статуса отдельно показывает опубликованные или скрытые товары. Оба условия применяются одновременно.', 'items' => ['Число групп применяемости показывает, для скольких наборов автомобилей настроен товар.', 'Скрытый товар остаётся в базе со всеми категориями, фотографиями и связями.', 'Справочник производителей открывается отдельной кнопкой над списком.']])
