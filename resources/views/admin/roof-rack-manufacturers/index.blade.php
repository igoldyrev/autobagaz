...
@section('body')
    <div class="admin-shell">
        ...
        <main class="admin-content admin-content--wide">
            ...
            @include('admin.partials.help', ['title' => 'Как работает справочник', 'text' => 'Здесь хранятся производители только автобагажников. Запись выбирается в карточке товара и используется в каталоге, фильтрах и группах применяемости.', 'items' => ['Поиск проверяет название производителя.', 'Скрытого производителя нельзя выбрать для нового товара, но существующие связи сохраняются.', 'Перед добавлением проверьте, нет ли производителя с другим написанием.']])
