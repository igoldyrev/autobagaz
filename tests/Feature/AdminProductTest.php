...
class AdminProductTest extends TestCase
{
    ...
    public function test_roof_rack_form_has_categories_and_only_fitment_based_applicability(): void
    {
        ...
        $this->actingAs($admin)
            ...
            ->assertSee('Система сравнивает ширину, высоту и T-паз дуги с креплением автобокса')
            ->assertSee('Внешняя ширина поперечного сечения дуги')
            ->assertSee('Если T-паза нет, оставьте поле пустым')
