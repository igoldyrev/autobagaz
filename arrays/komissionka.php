<?php 
/* Данные для раздела Комиссионка 
$bagazhniki - данные подраздела Автомобильные багажники
$farkops - данные подраздела Фаркопы
$korzins - данные подраздела Корзины
Изменять можно значения полей name и price, остальные нежелательно */
$bagazhniki = [
		[
			'id' => '1',
