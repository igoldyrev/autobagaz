...
<p class='page__text'>С общими правилами пользования багажным оборудованием можно ознакомиться <a class='page__link' href="/docs/Правила эксплуатации автобоксов.doc">здесь</a>.</p></div>
    </div>
