    ...
    <div class="wrapper__content">
        ...
        <div class="good">
            ...
            <div class="good__price">
                <span class="text"><?php echo $braslet['desc1']; ?> <span class="text"<?php echo $stylepricebraslet ?>><strong><?php echo $braslet['price1']; ?></strong></span></span>
        ...
        <div class="good">
            ...
            <div class="good__price">
                <span class="text"><?php echo $braslet['desc2']; ?> <span class="text"<?php echo $stylepricebraslet ?>><strong><?php echo $braslet['price2']; ?></strong></span></span>
                <div class="good__buttons">
        ...
        <div class="good">
            ...
            <div class="good__price">
                <span class="text"><?php echo $braslet['desc3']; ?> <span class="text"<?php echo $stylepricebraslet ?>><strong><?php echo $braslet['price3']; ?></strong></span></span>
                <div class="good__buttons">
