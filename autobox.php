...
<div class="wrapper">
	...
	<?php echo "<p class='page__text'>Цена "; echo $yuago[price]; echo "</p>";	?>
		...
		<button class="button__buy"><a class="button__buy-link" href="/buy/<?php echo $yuago['id']; ?>">Заказать</a></button>
		</div>
	</div> <?php
	...
	<?php echo "<p class='page__text'>"; echo $turino[price]; echo "</p>";	?>
		...
		<div class="good__price-button">
		<button class="button__buy"><a class="button__buy-link" href="/buy/<?php echo $turino['id']; ?>">Заказать</a></button>
		</div>
	</div> <?php
	include ($_SERVER["DOCUMENT_ROOT"]."/modules/forms/helpform.php");
} elseif ($autobox == 'lux') {
	...
	<table cellspacing="0" align="center">
		...
		<tr><td class="producttable" align="left"><?php echo $lux[name1]; ?></td><td class="producttable" align="center"><?php echo $lux[price1]; ?></td><td class="producttable"><button class="button__buy"><a class="button__buy-link" href="/buy/<?php echo $lux['id1']; ?>">Заказать</a></button></td></tr>
		<tr><td class="producttable" align="left"><?php echo $lux[name2]; ?></td><td class="producttable" align="center"><?php echo $lux[price2]; ?></td><td class="producttable"><button class="button__buy"><a class="button__buy-link" href="/buy/<?php echo $lux['id2']; ?>">Заказать</a></button></td></tr>
		<tr><td class="producttable" align="left"><?php echo $lux[name3]; ?></td><td class="producttable" align="center"><?php echo $lux[price3]; ?></td><td class="producttable"><button class="button__buy"><a class="button__buy-link" href="/buy/<?php echo $lux['id3']; ?>">Заказать</a></button></td></tr>
		<tr><td class="producttable" align="left"><?php echo $lux[name4]; ?></td><td class="producttable" align="center"><?php echo $lux[price4]; ?></td><td class="producttable"><button class="button__buy"><a class="button__buy-link" href="/buy/<?php echo $lux['id4']; ?>">Заказать</a></button></td></tr>
		<tr><td class="producttable" align="left"><?php echo $lux[name5]; ?></td><td class="producttable" align="center"><?php echo $lux[price5]; ?></td><td class="producttable"><button class="button__buy"><a class="button__buy-link" href="/buy/<?php echo $lux['id5']; ?>">Заказать</a></button></td></tr>
		<tr><td class="producttable" align="left"><?php echo $lux[name6]; ?></td><td class="producttable" align="center"><?php echo $lux[price6]; ?></td><td class="producttable"><button class="button__buy"><a class="button__buy-link" href="/buy/<?php echo $lux['id6']; ?>">Заказать</a></button></td></tr>
	</table> <?php
	include ($_SERVER["DOCUMENT_ROOT"]."/modules/forms/helpform.php");
	...
	<table align="center">
		<tr><td class="producttable"><?php echo $discoveryclassic[name1]; ?></td><td class="producttable"><?php echo $discoveryclassic[price1]; ?></td><td class="producttable"><button class="button__buy"><a class="button__buy-link" href="/buy/<?php echo $discoveryclassic['id1']; ?>">Заказать</a></button></td></tr>
		<tr><td class="producttable"><?php echo $discoveryclassic[name2]; ?></td><td class="producttable"><?php echo $discoveryclassic[price2]; ?></td><td class="producttable"><button class="button__buy"><a class="button__buy-link" href="/buy/<?php echo $discoveryclassic['id2']; ?>">Заказать</a></button></td></tr>
		<tr><td class="producttable"><?php echo $discoveryclassic[name3]; ?></td><td class="producttable"><?php echo $discoveryclassic[price3]; ?></td><td class="producttable"><button class="button__buy"><a class="button__buy-link" href="/buy/<?php echo $discoveryclassic['id3']; ?>">Заказать</a></button></td></tr>
	</table>
	<div class="img_div">
	...
	<table align="center">
		<tr><td class="producttable"><?php echo $discoverysport[name1]; ?></td><td class="producttable"><?php echo $discoverysport[price1]; ?></td><td class="producttable"><button class="button__buy"><a class="button__buy-link" href="/buy/<?php echo $discoverysport['id1']; ?>">Заказать</a></button></td></tr>
		<tr><td class="producttable"><?php echo $discoverysport[name2]; ?></td><td class="producttable"><?php echo $discoverysport[price2]; ?></td><td class="producttable"><button class="button__buy"><a class="button__buy-link" href="/buy/<?php echo $discoverysport['id2']; ?>">Заказать</a></button></td></tr>
	</table> <?php
	...
	<table align="center">
		<tr><td class="producttable"><?php echo $dynamic[name1]; ?></td><td class="producttable"><?php echo $dynamic[price1]; ?></td><td class="producttable"><button class="button__buy"><a class="button__buy-link" href="/buy/<?php echo $dynamic['id1']; ?>">Заказать</a></button></td></tr>
		<tr><td class="producttable"><?php echo $dynamic[name2]; ?></td><td class="producttable"><?php echo $dynamic[price2]; ?></td><td class="producttable"><button class="button__buy"><a class="button__buy-link" href="/buy/<?php echo $dynamic['id2']; ?>">Заказать</a></button></td></tr>
	</table>
	<div class="img_div">
	...
	<table align="center">
		<tr><td class="producttable"><?php echo $airtek[name1]; ?></td><td class="producttable"><?php echo $airtek[price1]; ?></td><td class="producttable"><button class="button__buy"><a class="button__buy-link" href="/buy/<?php echo $airtek['id1']; ?>">Заказать</a></button></td></tr>
		<tr><td class="producttable"><?php echo $airtek[name2]; ?></td><td class="producttable"><?php echo $airtek[price2]; ?></td><td class="producttable"><button class="button__buy"><a class="button__buy-link" href="/buy/<?php echo $airtek['id2']; ?>">Заказать</a></button></td></tr>
	</table> <?php
	include ($_SERVER["DOCUMENT_ROOT"]."/modules/forms/helpform.php");
               ...
               <div class="good"> <?php
                    ...
                    <div class="good__price">
                        <div class="good__price-info">
                            <table align="center">
                                <tr><td class="producttable" align="left"><b><?php echo "Черный: "; echo $vetlan[0]['price_black']; ?></b></td><td class="producttable" align="center"><button class="button__buy"><a class="button__buy-link" href="/buy/<?php echo $vetlan[0]['id1']; ?>">Заказать</a></button></td><td class="producttable" align="center"><button class="button__buy button__buy--prokat"><a class="button__buy-link" href="/prokat/<?php echo $vetlan[0]['id1']; ?>">Взять в прокат</a></button></td></tr>
                                <tr><td class="producttable" align="left"><b><?php echo "Серый: "; echo $vetlan[0]['price_gray']; ?></b></td><td class="producttable" align="center"><button class="button__buy"><a class="button__buy-link" href="/buy/<?php echo $vetlan[0]['id2']; ?>">Заказать</a></button></td><td class="producttable" align="center"><button class="button__buy button__buy--prokat"><a class="button__buy-link" href="/prokat/<?php echo $vetlan[0]['id2']; ?>">Взять в прокат</a></button></td></tr>
                                <tr><td class="producttable" align="left"><b><?php echo "Белый: "; echo $vetlan[0]['price_white']; ?></b></td><td class="producttable" align="center"><button class="button__buy"><a class="button__buy-link" href="/buy/<?php echo $vetlan[0]['id3']; ?>">Заказать</a></button></td><td class="producttable" align="center"><button class="button__buy button__buy--prokat"><a class="button__buy-link" href="/prokat/<?php echo $vetlan[0]['id3']; ?>">Взять в прокат</a></button></td></tr>
                            </table>
                        </div></div></div>
                    ...
                    <div class="good__price">
                        <div class="good__price-info">
                            <table align="center">
                                ...
                                <tr><td class="producttable" align="left"><b><?php echo "Серый: "; echo $vetlan[1]['price_gray']; ?></b></td><td class="producttable" align="center"><button class="button__buy"><a class="button__buy-link" href="/buy/<?php echo $vetlan[1]['id2']; ?>">Заказать</a></button></td><td class="producttable" align="center"><button class="button__buy button__buy--prokat"><a class="button__buy-link" href="/prokat/<?php echo $vetlan[1]['id2']; ?>">Взять в прокат</a></button></td></tr>
                                <tr><td class="producttable" align="left"><b><?php echo "Белый: "; echo $vetlan[1]['price_white']; ?></b></td><td class="producttable" align="center"><button class="button__buy"><a class="button__buy-link" href="/buy/<?php echo $vetlan[1]['id3']; ?>">Заказать</a></button></td><td class="producttable" align="center"><button class="button__buy button__buy--prokat"><a class="button__buy-link" href="/prokat/<?php echo $vetlan[1]['id3']; ?>">Взять в прокат</a></button></td></tr>
                            </table>
                        </div></div></div>
                ...
                <div class="good"> <?php
                    ...
                    <div class="good__price">
                        <div class="good__price-info">
                            <table align="center">
                                <tr><td class="producttable" align="left"><b><?php echo "Черный: "; echo $vetlan[2]['price_black']; ?></b></td><td class="producttable" align="center"><button class="button__buy"><a class="button__buy-link" href="/buy/<?php echo $vetlan[2]['id1']; ?>">Заказать</a></button></td><td class="producttable" align="center"><button class="button__buy button__buy--prokat"><a class="button__buy-link" href="/prokat/<?php echo $vetlan[2]['id1']; ?>">Взять в прокат</a></button></td></tr>
                                <tr><td class="producttable" align="left"><b><?php echo "Серый: "; echo $vetlan[2]['price_gray']; ?></b></td><td class="producttable" align="center"><button class="button__buy"><a class="button__buy-link" href="/buy/<?php echo $vetlan[2]['id2']; ?>">Заказать</a></button></td><td class="producttable" align="center"><button class="button__buy button__buy--prokat"><a class="button__buy-link" href="/prokat/<?php echo $vetlan[2]['id2']; ?>">Взять в прокат</a></button></td></tr>
                                <tr><td class="producttable" align="left"><b><?php echo "Белый: "; echo $vetlan[2]['price_white']; ?></b></td><td class="producttable" align="center"><button class="button__buy"><a class="button__buy-link" href="/buy/<?php echo $vetlan[2]['id3']; ?>">Заказать</a></button></td><td class="producttable" align="center"><button class="button__buy button__buy--prokat"><a class="button__buy-link" href="/prokat/<?php echo $vetlan[2]['id3']; ?>">Взять в прокат</a></button></td></tr>
                            </table>
                        </div></div></div> <?php
                include ($_SERVER["DOCUMENT_ROOT"]."/modules/forms/helpform.php");
            } ?>
