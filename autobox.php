...
<div class="wrapper">
  ...
  <div class="wrapper__content">
    ...
    if (!isset($autobox)) {
      ...
      <div class="catalog">
        ...
        <div class="catalog__item">
          ...
          <div class="catalog__image-wrap">
            <img class="catalog__image" src="/content/autobox/img/logo/inmax.png" alt="INMAX">
          </div>
          <div class="catalog__text">
        ...
        <div class="catalog__item">
          <a href="/autobox/terradrive" class="catalog__item-link"></a>
          <div class="catalog__image-wrap">
            <img class="catalog__image" src="/content/autobox/img/logo/terradrive.png" alt="Terra Drive">
          </div>
          <div class="catalog__text">
            <p class="text">Автомобильные боксы Terra Drive</p>
          </div>
        </div>
        <div class="catalog__item">
    ...
    <?php } elseif ($autobox == 'yuago') {
      ...
      echo "<h1 class='title title-h1'>Автомобильные боксы Koffer</h1>";
      echo "<p class='text'>Система двухстороннего открывания облегчает доступ к грузу в боксе. Ребра жёсткости на днище бокса полностью снимают эффект скручивания. Подъёмные штанги облегчают открывание крышки бокса и одновременно спроектированы так, что надёжно фиксируют крышку в закрытом состоянии. Идеальная геометрия крышки и днища даёт плотное прилегание, что не позволяет проникать грязи и пыли в грузовое пространство, а также обеспечивают лёгкое запирание/отпирание замка. П - образные крепежи - простые и надёжные, бокс устанавливается на багажные поперечины не более чем за 15-20 минут. В комплекте крепежа также присутствуют  ремни для крепления грузов. Цвета: чёрный и серый - матовые.</p>";
