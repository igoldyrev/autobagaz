<?php
echo "<title>Выбор товара для редактирования</title>";
...
<div class="admin__container">
  <h1 class="title title-h1">Выбор товара для редактирования</h1>
  ...
  <div class="form__container">
    <form action="/admin/komissionka/edit/itemwrite" method="post">
      <?php
      $select_sql = "SELECT * FROM komm_items INNER JOIN status ON komm_items.komm_items_status = status.status_name AND status.status_name <> 'УДАЛЕН'";
      ...
      ?>
      <input class="button button__zakaz" type="submit" value="Выбрать товар">
    </form>
  </div>
