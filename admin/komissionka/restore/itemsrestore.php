<?php echo "<title>Выбор товара для восстановления</title>";
...
<div class="admin__container">
  <h1 class="title title-h1">Выбор товара для восстановления</h1>
  ...
  <div class="form__container">
    <form action="/admin/komissionka/restore/restore" method="post">
      <?php
      ...
      ?>
      <input class="button button__zakaz" type="submit" value="Восстановить товар">
    </form>
  </div>
