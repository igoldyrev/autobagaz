<?php echo "<title>Выбор отзыва для восстановления</title>";
...
<div class="admin__container">
  <h1 class="title title-h1">Выбор отзыва для восстановления</h1>
  ...
  <div class="form__container">
    <form action="/admin/guestbook/restore/restore" method="post">
      <?php
      ...
      ?>
      <input class="button button__zakaz" type="submit" value="Восстановить отзыв">
    </form>
  </div>
