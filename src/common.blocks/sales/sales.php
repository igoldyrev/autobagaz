...
$sales = [
  ...
  [
    'id' => 's5',
    'name' => 'Лыжное крепление Amos  5-6 пар лыж/4 сноуборда',
    'img' => '<img class="sales__img" src="/content/lyzhnye-kreplenya/img/amos.jpg" alt="Лыжное крепление Amos  5-6 пар лыж">',
    'price' => '3 500 рублей',
    'strike_price' => '4 000 рублей',
  ],
  [
    'id' => 's6',
    'name' => 'Лыжное крепление Атлант 3-4-х пар лыж/2 сноуборда',
    'img' => '<img class="sales__img" src="/content/lyzhnye-kreplenya/img/atlant.jpg" alt="Лыжное крепление Атлант 3-4-х пар лыж/2 сноуборда">',
    'price' => '3 500 рублей',
    'strike_price' => '4 200 рублей',
  ],
];
